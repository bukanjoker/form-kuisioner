...
@section('script')
    <script>
        ...
        function deleteWord(id) {
            if (!confirm('Deleted item can`t be restored, are you sure to continue?')) {
                return
            }
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 offset-1">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="">
                                    <button class="text-danger" onclick="deleteWord({{$kata->id}})">
                                    ...
                                    <form action="/words/{{$kata->id}}/delete" method="post">
                                        @csrf
                                        <button id="deleteButton-{{$kata->id}}" class="d-none" type="submit" name="button"></button>
                                    </form>
                                </div>
                            </div>
                        </div>
